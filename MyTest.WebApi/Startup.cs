...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXafWebApi(builder => {
            ...
            builder.Modules
                ...
                .AddValidation()
                .Add<MyTest.Module.MyTestModule>();
            ...
            builder.AddBuildStep(application => {
                application.ApplicationName = "SetupApplication.MyTest";
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "MyTest API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the MyTest.WebApi\Startup.cs file to make Business Objects available in the Web API."
            });
        });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "MyTest WebApi v1");
            });
        }
        else {
